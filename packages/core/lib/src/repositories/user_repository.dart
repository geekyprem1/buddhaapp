...
class UserRepository with RepoGuard {
  ...
  Future<AppUser?> getUser(String uid) {
    return guardedRead('user.get', () async {
  ...
  Future<void> ensureUserDocument({
    ...
    return guardedWrite('user.ensure', () async {
  ...
  Future<void> touchLastActive(String uid) {
    return guardedWrite(
      ...
      () => _users.doc(uid).update({'lastActiveAt': DateTime.now()}),
    );
  }
  ...
  Future<void> updatePhotoUrl(String uid, String photoUrl) {
    return guardedWrite(
      'user.updatePhotoUrl',
      () => _users.doc(uid).update({'photoUrl': photoUrl}),
    );
  }
  ...
  Future<void> setPreferredLanguage(String uid, String languageCode) {
    return guardedWrite(
      ...
      () => _users.doc(uid).update({'language': languageCode}),
    );
  }
  ...
  Future<void> setNotificationPrefs(String uid, NotificationPrefs prefs) {
    return guardedWrite(
      ...
      () => _users.doc(uid).update({'notificationPrefs': prefs.toJson()}),
    );
  }
  ...
  Future<List<Map<String, dynamic>>> fetchDeletionRequests() {
    return guardedRead('user.fetchDeletionRequests', () async {
  ...
  Future<List<AppUser>> fetchAdminPage({
    ...
    return guardedRead('user.fetchAdminPage', () async {
  ...
  Future<void> setBlocked(String uid, bool blocked) {
    return guardedWrite(
      'user.setBlocked',
      () => _users.doc(uid).update({'isBlocked': blocked}),
    );
  }
}
